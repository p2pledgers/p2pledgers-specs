...
# # Levels
#
# df = pd.DataFrame(gen_all_records(range(16), "phone_mid"))
# df = df[base + params]
# df = df.sort_values(by=["level"], ascending=[True]) # type: ignore
#
# |  | level | num_bits | graph_size | density | num_graphs | buffer | max_ops | mean_ops |
# | --- | --- | --- | --- | --- | --- | --- | --- | --- |
# |  0 |  0 | 12 |  8 | 2.9 |    0.1 | 128 |   1 |   1 |
# |  1 |  1 | 17 | 15 | 5.2 |   0.08 | 256 |   1 | 1.2 |
# |  2 |  2 | 18 | 17 | 6.1 |  0.064 | 256 |   2 | 1.4 |
# |  3 |  3 | 18 | 17 | 6.1 |  0.051 | 256 |   2 | 1.6 |
# |  4 |  4 | 19 | 18 | 6.8 |  0.041 | 256 |   4 | 1.8 |
# |  5 |  5 | 19 | 18 | 6.9 |  0.033 | 256 |   4 |   2 |
# |  6 |  6 | 19 | 18 |   7 |  0.026 | 256 |   8 | 2.2 |
# |  7 |  7 | 19 | 19 | 7.5 |  0.021 | 256 |   8 | 2.4 |
# |  8 |  8 | 20 | 19 |   8 |  0.017 | 256 |  16 | 2.6 |
# |  9 |  9 | 20 | 19 | 8.1 |  0.013 | 512 |  16 | 2.8 |
# | 10 | 10 | 20 | 20 | 8.6 |  0.011 | 512 |  32 |   3 |
# | 11 | 11 | 20 | 20 | 8.7 | 0.0086 | 512 |  32 | 3.2 |
# | 12 | 12 | 20 | 20 | 8.8 | 0.0069 | 512 |  64 | 3.4 |
# | 13 | 13 | 20 | 20 |   9 | 0.0055 | 512 |  64 | 3.6 |
# | 14 | 14 | 20 | 20 | 9.1 | 0.0044 | 512 | 128 | 3.8 |
# | 15 | 15 | 20 | 20 | 9.3 | 0.0035 | 512 | 128 |   4 |
#
# # Mid-Range Phone
#
# df = pd.DataFrame(gen_all_records(range(16), "phone_mid"))
...
# df
#
# |  | level | build_ms | filter_ms | join_ms | hash_ms | writes_mb | reads_mb | total_ms |
# | --- | --- | --- | --- | --- | --- | --- | --- | --- |
# |  0 |  0 | 0.0046 | 0.012 | 0.011 | 0.51 |  0.2 | 0.71 | 0.54 |
# |  1 |  1 |    3.2 |   4.8 |   4.8 | 16.4 | 15.8 | 36.6 | 29.2 |
# |  2 |  2 |   15.6 |  13.3 |  11.2 | 32.8 | 57.2 |  125 | 72.9 |
# |  3 |  3 |   16.6 |  14.7 |  10.5 | 32.8 | 60.6 |  134 | 74.5 |
# |  4 |  4 |   38.4 |  30.1 |  20.0 | 65.5 |  131 |  302 |  154 |
# |  5 |  5 |   40.7 |  33.2 |  18.8 | 65.5 |  139 |  326 |  158 |
# |  6 |  6 |   43.0 |  36.7 |  17.7 | 65.5 |  148 |  350 |  163 |
# |  7 |  7 |   94.8 |  55.4 |  20.4 | 65.5 |  267 |  703 |  236 |
# |  8 |  8 |    104 |  83.6 |  32.3 |  131 |  340 |  857 |  351 |
# |  9 |  9 |    110 |  92.4 |  30.7 |  131 |  362 |  919 |  364 |
# | 10 | 10 |    242 |   140 |  34.7 |  131 |  647 | 1893 |  547 |
# | 11 | 11 |    254 |   154 |  32.9 |  131 |  686 | 2033 |  572 |
# | 12 | 12 |    266 |   171 |  31.3 |  131 |  729 | 2177 |  599 |
# | 13 | 13 |    279 |   189 |  29.8 |  131 |  777 | 2328 |  628 |
# | 14 | 14 |    292 |   209 |  28.5 |  131 |  829 | 2484 |  660 |
# | 15 | 15 |    305 |   231 |  27.3 |  131 |  887 | 2645 |  694 |
#
# Shared Server
#
# df = pd.DataFrame(gen_all_records(range(16), "server_shared"))
# df = df[base + components]
# df = df.sort_values(by=["level"], ascending=[True]) # type: ignore
# df
#
# |  | level | build_ms | filter_ms | join_ms | hash_ms | writes_mb | reads_mb | total_ms |
# | --- | --- | --- | --- | --- | --- | --- | --- | --- |
# |  0 |  0 | 0.0027 | 0.011 | 0.011 | 0.26 |  0.2 | 0.71 | 0.28 |
# |  1 |  1 |    1.9 |     3 |     3 |  8.2 | 15.8 | 36.6 | 16.1 |
# |  2 |  2 |    9.1 |   8.3 |     7 | 16.4 | 57.2 |  125 | 40.8 |
# |  3 |  3 |    9.6 |   9.2 |   6.5 | 16.4 | 60.6 |  134 | 41.7 |
# |  4 |  4 |   22.1 |  18.8 |  12.5 | 32.8 |  131 |  302 | 86.2 |
# |  5 |  5 |   23.3 |  20.8 |  11.7 | 32.8 |  139 |  326 | 88.6 |
# |  6 |  6 |   24.5 |  23.0 |  11.1 | 32.8 |  148 |  350 | 91.3 |
# |  7 |  7 |   53.8 |  34.6 |  12.8 | 32.8 |  267 |  703 |  134 |
# |  8 |  8 |   59.0 |  52.2 |  20.2 | 65.5 |  340 |  857 |  197 |
# |  9 |  9 |   61.8 |  57.7 |  19.2 | 65.5 |  362 |  919 |  204 |
# | 10 | 10 |    135 |  87.2 |  21.7 | 65.5 |  647 | 1893 |  310 |
# | 11 | 11 |    141 |  96.5 |  20.6 | 65.5 |  686 | 2033 |  324 |
# | 12 | 12 |    148 |   107 |  19.6 | 65.5 |  729 | 2177 |  340 |
# | 13 | 13 |    154 |   118 |  18.6 | 65.5 |  777 | 2328 |  357 |
# | 14 | 14 |    161 |   131 |  17.8 | 65.5 |  829 | 2484 |  375 |
# | 15 | 15 |    168 |   144 |  17.1 | 65.5 |  887 | 2645 |  395 |
